...
- [5. Glyph substitution (GSUB) rules](#5)
  ...
  - [f. [GSUB LookupType 6] Chaining contextual substitution](#5.f)
    - [i.  Specifying a Chain Substitution rule and marking sub-runs](#5.f.i)
    - [ii. Specifying exceptions to the Chain Substitution rule](#5.f.ii)
...
- [6. Glyph positioning (GPOS) rules](#6)
  ...
  - [h. [GPOS LookupType 8] Chaining contextual positioning](#6.h)
    - [i.   Specifying a Chain Positioning rule and marking sub-runs](#6.h.i)
    - [ii.  Specifying Contextual Positioning with explicit lookup references](#6.h.ii)
    - [iii. Specifying Contextual Positioning with in-line single positioning rules](#6.h.iii)
    - [iv.  Specifying Contextual Positioning with in-line cursive positioning rules](#6.h.iv)
    - [v.   Specifying Contextual Positioning with in-line mark attachment positioning rules](#6.h.v)
    - [vi.  Specifying exceptions to the Chain Positioning rule](#6.h.vi)
...
- [8. Specially handled features](#8)
  ...
  - [d. UI label names for Character Variant features (`cv01` - `cv99`)](#8.d)
